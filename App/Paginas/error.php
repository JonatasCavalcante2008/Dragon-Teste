...
<body translate="no" >
    ...
    <p class="subtitle">
        Você está digitando a URL incorretamente <br /> ou solicitando uma página que não está mais aqui.
    </p>
    <div align="center">
        <a class="btn-back" href="javascript:history.back();">Voltar ao Site</a>
    </div>
